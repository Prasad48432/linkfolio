...
const Home = () => {
  ...
  return (
    <>
      {subscription === "elite" || subscription === "core" ? (
        <>
          <div
        ...
        <div className="flex gap-2 h-auto lg:h-[calc(100vh-100px)] relative items-center justify-center">
          <AnimatedLoader />
        </div>
      ) : (
        <div className="flex gap-2 h-auto lg:h-[calc(100vh-100px)] relative items-center justify-center">
          <p>You have caught a premium feature</p>
        </div>
      )}
    </>
  );
