...
export function CheckoutContents({ userEmail }: Props) {
  ...
  return (
    <div
      className={
        "rounded-lg md:bg-lightsecondary-selection dark:md:dark:bg-secondary-bg md:backdrop-blur-[24px] md:p-10 md:pl-16 md:pt-16 md:min-h-[400px] flex flex-col justify-between relative"
      }
    >
      <div className={"flex flex-col md:flex-row gap-8 md:gap-16"}>
        ...
        <div className={"min-w-[375px] lg:min-w-[535px]"}>
          <div className={"text-lg text-lightprimary-text dark:text-primary-text leading-[20px] font-semibold mb-8"}>
            Payment details
          </div>
