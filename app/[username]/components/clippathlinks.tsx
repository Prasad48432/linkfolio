...
export const ClipLinks = () => {
  return (
    <div className="bg-primary-bg px-4 py-6">
...
const ClipPathLinks = () => {
  return (
    <div className="divide-y divide-secondary-border border border-secondary-border">
      <div className="grid grid-cols-2 divide-x divide-secondary-border">
        <LinkBox Icon={SiGoogle} href="#" />
        <LinkBox Icon={SiShopify} href="#" />
      </div>
      <div className="grid grid-cols-4 divide-x divide-secondary-border">
